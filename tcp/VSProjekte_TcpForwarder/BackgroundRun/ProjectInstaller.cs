...
namespace TcpForwarder.BackgroundRun {
    /// <summary>
    /// Installer component which installs the TcpForwarderService. Use InstallUtil.exe to install the service.
    ...
    public class ProjectInstaller : Installer {
        ...
        public ProjectInstaller() {
            ...
            serviceInstaller1.ServiceName = TcpForwarderService.MyServiceName;
        }
